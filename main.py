    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                dataTimeObject = datetime.strptime(studentInfo['last_attendance_time_stamp'], "%Y-%m-%d %H:%M:%S")
                ...
                if secondsElapsed > 30:
                    ...
                    ref.child('last_attendance_time_stamp').set(datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
                else:
                    modeType = 3
                    counter = 0
                    imgBackground[44:44 + 633, 808:808 + 414] = imgModeList[modeType]
